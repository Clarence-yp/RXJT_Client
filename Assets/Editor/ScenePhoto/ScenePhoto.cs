...
public class ScenePhoto : EditorWindow {
  ...
  private static string DEFAULT_PHOTO_SAVE_PATH = Path.Combine(Application.dataPath, "../../../Public/Resource/Public/Scenes");
  ...
  private void Initialize() {
    ...
    PhotoSize = new Vector2(1536.0f, 1536.0f);
  ...
  private void TakePhoto() {
    ...
    try {
      GameObject airWallContainer = GameObject.Find("EventObj/StaticAirWall");
