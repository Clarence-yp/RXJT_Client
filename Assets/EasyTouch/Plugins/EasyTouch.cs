...
public class EasyTouch : MonoBehaviour {
	...
	#region Delegate
  public delegate void TouchCancelHandler(EasyTouchGesture gesture);
  public delegate void Cancel2FingersHandler(EasyTouchGesture gesture);
  public delegate void TouchStartHandler(EasyTouchGesture gesture);
  public delegate void TouchDownHandler(EasyTouchGesture gesture);
  public delegate void TouchUpHandler(EasyTouchGesture gesture);
  public delegate void SimpleTapHandler(EasyTouchGesture gesture);
  public delegate void DoubleTapHandler(EasyTouchGesture gesture);
  public delegate void LongTapStartHandler(EasyTouchGesture gesture);
  public delegate void LongTapHandler(EasyTouchGesture gesture);
  public delegate void LongTapEndHandler(EasyTouchGesture gesture);
  public delegate void DragStartHandler(EasyTouchGesture gesture);
  public delegate void DragHandler(EasyTouchGesture gesture);
  public delegate void DragEndHandler(EasyTouchGesture gesture);
  public delegate void SwipeStartHandler(EasyTouchGesture gesture);
  public delegate void SwipeHandler(EasyTouchGesture gesture);
  public delegate void SwipeEndHandler(EasyTouchGesture gesture);
  public delegate void TouchStart2FingersHandler(EasyTouchGesture gesture);
  public delegate void TouchDown2FingersHandler(EasyTouchGesture gesture);
  public delegate void TouchUp2FingersHandler(EasyTouchGesture gesture);
  public delegate void SimpleTap2FingersHandler(EasyTouchGesture gesture);
  public delegate void DoubleTap2FingersHandler(EasyTouchGesture gesture);
  public delegate void LongTapStart2FingersHandler(EasyTouchGesture gesture);
  public delegate void LongTap2FingersHandler(EasyTouchGesture gesture);
  public delegate void LongTapEnd2FingersHandler(EasyTouchGesture gesture);
  public delegate void TwistHandler(EasyTouchGesture gesture);
  public delegate void TwistEndHandler(EasyTouchGesture gesture);
  public delegate void PinchInHandler(EasyTouchGesture gesture);
  public delegate void PinchOutHandler(EasyTouchGesture gesture);
  public delegate void PinchEndHandler(EasyTouchGesture gesture);
  public delegate void DragStart2FingersHandler(EasyTouchGesture gesture);
  public delegate void Drag2FingersHandler(EasyTouchGesture gesture);
  public delegate void DragEnd2FingersHandler(EasyTouchGesture gesture);
  public delegate void SwipeStart2FingersHandler(EasyTouchGesture gesture);
  public delegate void Swipe2FingersHandler(EasyTouchGesture gesture);
  public delegate void SwipeEnd2FingersHandler(EasyTouchGesture gesture);
	#endregion
	...
	private void CreateGesture(int touchIndex,EventName message,Finger finger,float actionTime, SwipeType swipe, float swipeLength, Vector2 swipeVector){
      ...
      EasyTouchGesture gesture = new EasyTouchGesture();
  ...
  private void SendGesture(EventName message, EasyTouchGesture gesture)
  {
  ...
  private void SendGesture2Finger(EventName message, EasyTouchGesture gesture)
  {
  ...
  private void RaiseEvent(EventName evnt, EasyTouchGesture gesture)
  {
