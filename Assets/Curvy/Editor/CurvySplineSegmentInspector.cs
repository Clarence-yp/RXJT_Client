...
public class CurvySplineSegmentInspector : Editor {
    ...
    void OnSceneGUI()
    {
        Handles.ArrowHandleCap(0, Target.Position, Quaternion.LookRotation(Target.Transform.up), 2, EventType.MouseDown);
        ...
        if (IsActive) {
            ...
            if (hasLocalHandles) {
                ...
                Target.HandleOutPosition = CurvyEditorUtility.PositionHandle(GUIUtility.GetControlID(FocusType.Passive), Target.HandleOutPosition, Tools.handleRotation,0.5f,
                                                                ...
                                                                ConstrainYAxis,
                                                                ConstrainZAxis);
                Handles.CubeHandleCap(0, Target.HandleOutPosition, Quaternion.identity, HandleUtility.GetHandleSize(Target.HandleOutPosition) * 0.1f, EventType.MouseDown);
                ...
                Target.HandleInPosition = CurvyEditorUtility.PositionHandle(GUIUtility.GetControlID(FocusType.Passive), Target.HandleInPosition, Tools.handleRotation,0.5f,
                                                                ...
                                                                ConstrainYAxis,
                                                                ConstrainZAxis);
                Handles.CubeHandleCap(0, Target.HandleInPosition, Quaternion.identity, HandleUtility.GetHandleSize(Target.HandleInPosition) * 0.1f, EventType.MouseDown);
