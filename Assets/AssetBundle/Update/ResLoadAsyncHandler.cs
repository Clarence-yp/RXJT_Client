...
namespace DashFire
{
  ...
  public class AssetLoadItemHandler : AsynCmdDoneHandler
  {
    ...
    public void Execute(AssetEx asset)
    {
      ...
      if (UITextureObj != null && asset.AssetRef != null) {
        UITextureObj.mainTexture = asset.AssetRef as Texture;
      }
  ...
  {
    public static void LoadAsyncItem(string targetAsset, UITexture uiTextureObj)
    {
