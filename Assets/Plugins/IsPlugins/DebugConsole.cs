  ...
  */
  ...
  void OnGUI()
  {
    ...
    if (Input.touchCount == 1) {
      ...
      if (evt.type == EventType.Repaint && (touch.phase == TouchPhase.Canceled || touch.phase == TouchPhase.Ended) && touch.tapCount == 8 && !_isLastHitUi) {
  ...
  {
    GameObject obj = GameObject.Find("GfxGameRoot");
    if (null != obj) {
      obj.SendMessage("OnResetDsl", args[1]);
    }
  ...
  object CMDScript(params string[] args)
  {
    if (args.Length == 2) {
      ...
      return "gm script need argument filename.";
    }
  }
