...
namespace DashFire
{
    internal class FilePathDefine
    {
        ...
        //服务端专用
        public const string C_GowConstConfig = @"Server/Gow/GowConst.txt";
        public const string C_GowFormulaConfig = @"Server/Gow/GowFormula.txt";
        public const string C_GmListConfig = @"Server/GmList.txt";

        public const string C_LogicServerConfig = @"Server/LogicServerConfig.txt";
    }
    public class FilePathDefine_Server
    {
        public const string C_RootPath = "data/";
        public const string C_FirstName = C_RootPath + FilePathDefine.C_FirstName;
        public const string C_LastName = C_RootPath + FilePathDefine.C_CuteLastName;
        public const string C_CuteFirstName = C_RootPath + FilePathDefine.C_CuteFirstName;
        public const string C_CuteLastName = C_RootPath + FilePathDefine.C_CuteLastName;
        public const string C_ChineseFirstName = C_RootPath + FilePathDefine.C_ChineseFirstName;
        public const string C_ChineseLastName = C_RootPath + FilePathDefine.C_ChineseLastName;
        public const string C_ForeignFirstName = C_RootPath + FilePathDefine.C_ForeignFirstName;
        public const string C_ForeignLastName = C_RootPath + FilePathDefine.C_ForeignLastName;
        ...
        public const string C_GowConstConfig = C_RootPath + FilePathDefine.C_GowConstConfig;
        public const string C_GowFormulaConfig = C_RootPath + FilePathDefine.C_GowFormulaConfig;
        // GM
        public const string C_GmListConfig = C_RootPath + FilePathDefine.C_GmListConfig;

        public const string C_SkillDslPath = C_RootPath + FilePathDefine.C_SkillDslPath;
        public const string C_LogicServerConfig = C_RootPath + FilePathDefine.C_LogicServerConfig;
