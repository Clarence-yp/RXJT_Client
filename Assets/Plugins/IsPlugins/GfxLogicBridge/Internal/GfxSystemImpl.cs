    ...
    public sealed partial class GfxSystem
    {
        ...
        private void PlayAnimationImpl(int id, string animationName, bool isStopAll)
        {
            ...
            if (null != obj && null != obj.GetComponent<Animation>())
            {
                try
                {
                    ...
                    {
                        obj.GetComponent<Animation>().Play(animationName, isStopAll ? PlayMode.StopAll : PlayMode.StopSameLayer);
                        //CallLogicLog("Obj {0} PlayerAnimation {1} clipcount {2}", id, animationName, obj.animation.GetClipCount());
                    }
                    else
                    {
                        CallLogicErrorLog("Obj {0} PlayerAnimation {1} AnimationState is null, clipcount {2}", id, animationName, obj.GetComponent<Animation>().GetClipCount());
                    }
                }
                catch
                {
        ...
        private void StopAnimationImpl(int id, string animationName)
        {
            ...
            if (null != obj && null != obj.GetComponent<Animation>())
            {
                try
                {
                    ...
                    {
                        CallLogicErrorLog("Obj {0} StopAnimation {1} AnimationState is null, clipcount {2}", id, animationName, obj.GetComponent<Animation>().GetClipCount());
                    }
                }
                catch
                {
        ...
        private void BlendAnimationImpl(int id, string animationName, float weight, float fadeLength)
        {
            ...
            if (null != obj && null != obj.GetComponent<Animation>())
            {
                try
                {
                    AnimationState state = obj.GetComponent<Animation>()[animationName];
                    if (null != state)
                    {
                    ...
                    {
                        CallLogicErrorLog("Obj {0} BlendAnimation {1} AnimationState is null, clipcount {2}", id, animationName, obj.GetComponent<Animation>().GetClipCount());
                    }
                }
                catch
                {
        ...
        private void CrossFadeAnimationImpl(int id, string animationName, float fadeLength, bool isStopAll)
        {
            ...
            if (null != obj && null != obj.GetComponent<Animation>())
            {
                try
                {
                    if (null != obj.GetComponent<Animation>()[animationName] && obj_info != null && !obj_info.IsGfxAnimation)
                    {
                        obj.GetComponent<Animation>().CrossFade(animationName, fadeLength, isStopAll ? PlayMode.StopAll : PlayMode.StopSameLayer);
        ...
        private void PlayQueuedAnimationImpl(int id, string animationName, bool isPlayNow, bool isStopAll)
        {
            ...
            if (null != obj && null != obj.GetComponent<Animation>())
            {
                try
                {
                    if (null != obj.GetComponent<Animation>()[animationName])
                    {
                        obj.GetComponent<Animation>().PlayQueued(animationName, isPlayNow ? QueueMode.PlayNow : QueueMode.CompleteOthers, isStopAll ? PlayMode.StopAll : PlayMode.StopSameLayer);
                        //CallLogicLog("Obj {0} PlayQueuedAnimation {1} clipcount {2}", id, animationName, obj.animation.GetClipCount());
                    }
                    else
                    {
                        CallLogicErrorLog("Obj {0} PlayQueuedAnimation {1} AnimationState is null, clipcount {2}", id, animationName, obj.GetComponent<Animation>().GetClipCount());
                    }
                }
                catch
                {
        ...
        private void CrossFadeQueuedAnimationImpl(int id, string animationName, float fadeLength, bool isPlayNow, bool isStopAll)
        {
            ...
            if (null != obj && null != obj.GetComponent<Animation>())
            {
                try
                {
                    if (null != obj.GetComponent<Animation>()[animationName])
                    {
                        obj.GetComponent<Animation>().CrossFadeQueued(animationName, fadeLength, isPlayNow ? QueueMode.PlayNow : QueueMode.CompleteOthers, isStopAll ? PlayMode.StopAll : PlayMode.StopSameLayer);
                        //CallLogicLog("Obj {0} CrossFadeQueuedAnimation {1} clipcount {2}", id, animationName, obj.animation.GetClipCount());
                    }
                    else
                    {
                        CallLogicErrorLog("Obj {0} CrossFadeQueuedAnimation {1} AnimationState is null, clipcount {2}", id, animationName, obj.GetComponent<Animation>().GetClipCount());
                    }
                }
                catch
                {
        ...
        private void RewindAnimationImpl(int id, string animationName)
        {
            ...
            if (null != obj && null != obj.GetComponent<Animation>())
            {
                try
                {
                    ...
                    {
                        CallLogicErrorLog("Obj {0} RewindAnimation {1} AnimationState is null, clipcount {2}", id, animationName, obj.GetComponent<Animation>().GetClipCount());
                    }
                }
                catch
                {
        ...
        private void SetAnimationSpeedImpl(int id, string animationName, float speed)
        {
            ...
            if (null != obj && null != obj.GetComponent<Animation>())
            {
                try
                {
                    ...
                    {
                        CallLogicErrorLog("Obj {0} SetAnimationSpeed {1} AnimationState is null, clipcount {2}", id, animationName, obj.GetComponent<Animation>().GetClipCount());
                    }
                }
                catch
                {
        ...
        private void SetAnimationSpeedByTimeImpl(int id, string animationName, float time)
        {
            ...
            if (null != obj && null != obj.GetComponent<Animation>())
            {
                try
                {
                    ...
                    {
                        CallLogicErrorLog("Obj {0} SetAnimationSpeedByTime {1} AnimationState is null, clipcount {2}", id, animationName, obj.GetComponent<Animation>().GetClipCount());
                    }
                }
                catch
                {
        ...
        private void SetAnimationWeightImpl(int id, string animationName, float weight)
        {
            ...
            if (null != obj && null != obj.GetComponent<Animation>())
            {
                try
                {
                    ...
                    {
                        CallLogicErrorLog("Obj {0} SetAnimationWeight {1} AnimationState is null, clipcount {2}", id, animationName, obj.GetComponent<Animation>().GetClipCount());
                    }
                }
                catch
                {
        ...
        private void SetAnimationLayerImpl(int id, string animationName, int layer)
        {
            ...
            if (null != obj && null != obj.GetComponent<Animation>())
            {
                try
                {
                    ...
                    {
                        CallLogicErrorLog("Obj {0} SetAnimationLayer {1} AnimationState is null, clipcount {2}", id, animationName, obj.GetComponent<Animation>().GetClipCount());
                    }
                }
                catch
                {
        ...
        private void SetAnimationBlendModeImpl(int id, string animationName, int blendMode)
        {
            ...
            if (null != obj && null != obj.GetComponent<Animation>())
            {
                try
                {
                    ...
                    {
                        CallLogicErrorLog("Obj {0} SetAnimationBlendMode {1} AnimationState is null, clipcount {2}", id, animationName, obj.GetComponent<Animation>().GetClipCount());
                    }
                }
                catch
                {
        ...
        private void AddMixingTransformAnimationImpl(int id, string animationName, string path, bool recursive)
        {
            ...
            if (null != obj && null != obj.GetComponent<Animation>() && null != obj.transform)
            {
                try
                {
                    ...
                    {
                        CallLogicErrorLog("Obj {0} AddMixingTransformAnimation {1} AnimationState is null, clipcount {2}", id, animationName, obj.GetComponent<Animation>().GetClipCount());
                    }
                }
                catch
                {
